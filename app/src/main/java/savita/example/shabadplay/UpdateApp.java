...
public class UpdateApp {
    ...
    public void flexiableUpdate(AppUpdateManager appUpdateManager, View view2,Context context){
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            ...
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                popupSnackBarForCompleteUpdate(appUpdateManager,view2,context);
            }
        });
    }
    public void popupSnackBarForCompleteUpdate(AppUpdateManager appUpdateManager, View view2,Context context) {
